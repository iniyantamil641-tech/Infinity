...
export default function ChatCoach() {
  ...
  useEffect(() => {
    document.title = 'Communication Coach | INFINITY'
    fetchHistory()
  }, [fetchHistory])
  ...
  return (
    <div className="page-content anim-fade">
      <div className="page-header">
        ...
        <p className="page-subtitle">Type any message — INFINITY analyzes tone, confidence, and suggests improvements.</p>
      </div>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:'20px' }}>
          ...
          {!result && !loading && (
            <Card className="anim-fade" style={{ textAlign:'center', padding:'60px 24px' }}>
              ...
              <h3 style={{ fontFamily:'var(--font-display)', fontWeight:'700', marginBottom:'8px' }}>INFINITY Awaiting Your Message</h3>
