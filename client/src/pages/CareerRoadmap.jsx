...
export default function CareerRoadmap() {
  ...
  useEffect(() => {
    document.title = 'Career Roadmap | INFINITY'
    roadmapAPI.getMy()
      .then(r => {
  ...
  return (
    <div className="page-content anim-fade">
      <div className="page-header">
        ...
        <p className="page-subtitle">Expert-level skill mapping and career trajectory planning powered by INFINITY.</p>
      </div>
           ...
           {loading && (
             <Card>
               <div style={{ textAlign:'center', padding:'60px 20px' }}>
                 ...
                 <p style={{ color:'var(--text-muted)' }}>INFINITY is calculating the optimal path for {goal}…</p>
