...
export default function ResumeAnalyzer() {
  ...
  useEffect(() => {
    document.title = 'Resume Analyzer | INFINITY'
    fetchHistory()
  }, [fetchHistory])
  ...
  return (
    <div className="page-content anim-fade" style={{ maxWidth: '1600px' }}>
      <div className="page-header">
        ...
        <p className="page-subtitle">Premium INFINITY-powered diagnostics for your technical career.</p>
      </div>
