          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
            <section className="anim-slide delay-1">
              ...
              <p className="text-responsive" style={paragraphStyle}>
                INFINITY collects information you provide directly to us when you create an account, upload a resume, or interact with our AI career coach. This includes your name, email, professional history, and skill data.
              </p>
            </section>
