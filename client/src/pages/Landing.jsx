  ...
  return (
    <div className="landing-page">
      ...
      <nav className="landing-nav">
        <div className="nav-logo">INFINITY</div>
      ...
      <section className="hero-section">
        ...
        <h1 className="hero-title">
          Your Career,<br/>Transformed<br/>by Your INFINITY
        </h1>
      ...
      <section className="onboarding-section">
        <div className="onboarding-header">
          <div>
            ...
            <p>Three stages to architect your digital reflection. Your INFINITY learns from your history to predict your future.</p>
          </div>
        ...
        <div className="onboarding-grid">
          ...
          <div className="onboard-card">
            ...
            <p>Define your North Star. Your INFINITY maps the roadmap, identifies skill gaps, and prepares the strategy.</p>
          </div>
        </div>
      </section>
      ...
      <section id="methodology" className="methodology-section">
        ...
        <div className="methodology-box">
          ...
          <div className="m-step active">
            ...
            <p>Constructing a multi-dimensional skill vector. Your INFINITY learns your unique professional "DNA".</p>
          </div>
          ...
          <div className="codebot-mock">
            <div className="cb-window">
              <div className="cb-header">
                ...
                <div className="cb-title">🤖 INFINITY</div>
            ...
            <div className="mock-window">
              ...
              <div className="mock-split">
                ...
                <div className="mock-right">
                  <span className="m-label" style={{color: 'var(--cyan)'}}>INFINITY SUGGESTION</span>
      ...
      <section id="pricing" className="pricing-section">
        <div className="pricing-header">
          ...
          <p>Choose the neural tier that matches your career velocity. All plans include 24/7 INFINITY availability.</p>
        </div>
