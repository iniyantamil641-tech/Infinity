        ...
        <div className="glass-card anim-scale glass-card-mobile" style={{ padding: '60px', position: 'relative', overflow: 'hidden' }}>
          ...
          <header style={{ marginBottom: '48px' }}>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '1rem', fontWeight: '500' }}>
              INFINITY Lifecycle Oversight · Last Updated: April 2026
            </p>
          </header>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
            <section className="anim-slide delay-1">
              ...
              <p className="text-responsive" style={paragraphStyle}>
                By accessing or using INFINITY, you agree to be bound by these Terms of Service. If you do not agree to all of the terms, you may not use the service.
              </p>
            </section>
            ...
            <section className="anim-slide delay-3">
              ...
              <p className="text-responsive" style={paragraphStyle}>
                All software, designs, and content provided by INFINITY are protected by intellectual property laws. You may not copy, reverse-engineer, or commercially exploit any part of our service.
              </p>
            </section>
