...
export default function Dashboard() {
  ...
  useEffect(() => {
    document.title = 'Dashboard | INFINITY'
    dashboardAPI.get()
  ...
  if (loading) return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '70vh' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ color: 'var(--text-muted)' }}>Loading INFINITY Dashboard…</p>
      </div>
    </div>
  )
  ...
  return (
    <>
      ...
      <div style={{ marginBottom: 28 }}>
        ...
        <p className="page-subtitle">Your INFINITY career intelligence — live and synchronized.</p>
      </div>
