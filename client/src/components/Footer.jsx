  ...
  return (
    <footer style={{ marginTop: '40px', paddingBottom: '24px', textAlign: 'center' }} className="anim-fade">
      <div style={{ display: 'flex', justifyContent: 'center', gap: '20px', flexWrap: 'wrap', marginBottom: '16px' }}>
        ...
        <a href="https://status.infinity.ai" target="_blank" rel="noopener noreferrer" style={linkStyle}>System Status</a>
      </div>
      <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>
        © {currentYear} INFINITY Release USver. All rights reserved.
      </p>
    </footer>
  )
}
