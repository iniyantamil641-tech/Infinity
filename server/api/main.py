...
from api.routes import auth, ai_services, career, dashboard
...
app = FastAPI(
    title="INFINITY API",
    description="Backend for the INFINITY Career Development Platform",
    version="1.2.0",
    docs_url="/api/docs",
    redoc_url="/api/redoc",
...
def on_startup():
    ...
    print("✅ INFINITY API — Consolidated Core + Temporal Anchor initialized")
